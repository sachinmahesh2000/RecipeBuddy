...
<body style="font-family: 'Abhaya Libre', serif">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navcol-2">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link fs-4 fw-semibold" href="recipes.php">Recipes</a>
          </li>
          <li class="nav-item">
          ...
          if (isset($_SESSION['Username']) && $_SESSION['loggedin'] == true) {
            ...
            echo '<li class="nav-item"><a class="nav-link fs-4 active fw-semibold" href="mybook.php">My Book</a></li>';
  ...
  <div class="container py-4 py-xl-5">
    ...
    <div class="row mb-5 flex-row justify-content-end align-content-end">
      <div class="flex-column justify-content-end align-content-end">
